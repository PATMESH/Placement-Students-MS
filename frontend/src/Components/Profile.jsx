                ...
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <div className="mt-2">
                    <h5 style={{ fontWeight: "bold" }}>
                      {user.name.toUpperCase()} {user.fatherName.toUpperCase()}
                    </h5>
                    <p
                ...
                <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 className="mb-0">
                    ...
                    >
                      ...
                      <path
                        fill="#c048dd"
                        d="M2.614 34.869c0-17.192 13.881-31.125 30.999-31.125 9.505 0 18.007 4.299 23.692 11.061C51.69 6.845 42.452 1.646 31.999 1.646 14.881 1.646 1 15.579 1 32.771A31.04 31.04 0 0 0 8.344 52.87a31.03 31.03 0 0 1-5.73-18.001z"
                  ...
                  >
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap" }}>
                      {user.skills.map((skill, idx) => (
                        <div
                          key={idx}
                          style={{ flex: "0 0 30.33%", padding: "8px" }}
                        >
                          <Button>{skill}</Button>
                        </div>
                      ))}
